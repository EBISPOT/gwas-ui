 ...
 */
@Controller
public class GeneControllerV2 {


    private SearchConfiguration searchConfiguration;

    @Autowired
    public GeneControllerV2(SearchConfiguration searchConfiguration) {
    ...
    @RequestMapping(value = "/v2/genes/{geneId:.+}", produces = MediaType.TEXT_HTML_VALUE)
