...
Association data in the GWAS Catalog is mapped to genome using the latest version of Ensembl. For details on genome assembly and dbSNP build, refer to the GWAS Catalog https://www.ebi.ac.uk/gwas[homepage].
