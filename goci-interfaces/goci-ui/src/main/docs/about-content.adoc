...
link:images/Privacy_Notice_GWAS_PGS_Catalogs_deposition_services.pdf[GWAS & PGS Catalog Deposition Services] applies to the data submitted to the GWAS Catalog (eg. Summary statistics files).
...
link:images/Privacy_Notice_GWAS_PGS_Catalog_public_websites.pdf[GWAS & PGS Catalog Public Websites] applies to cookies and limited processing of personal data required for the website to function.  
