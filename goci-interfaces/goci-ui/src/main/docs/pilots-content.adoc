...
Data from the studies curated as part of the targeted array can be found link:https://ftp.ebi.ac.uk/pub/databases/gwas/pilot_data/targeted_array_201607/[on our FTP server].
...
Data submitted as part of the author deposition pilot can be found link:https://ftp.ebi.ac.uk/pub/databases/gwas/pilot_data/author_submission_201608/[on our FTP server].
