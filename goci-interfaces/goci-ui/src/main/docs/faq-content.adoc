...
5. <<faq-H5,How should I cite summary statistics downloaded from the GWAS Catalog?>>

6. <<faq-H6,What are harmonised summary statistics?>>

7. <<faq-H7,What are the risks of subject identification associated with sharing of summary statistics?>>
...
==== [[faq-H5]]5. How should I cite summary statistics downloaded from the GWAS Catalog?
...
==== [[faq-H6]]6. What are standardised/harmonised summary statistics?

Please refer to the documentation https://www.ebi.ac.uk/gwas/docs/methods/summary-statistics[here].

==== [[faq-H7]]7. What are the risks of subject identification associated with sharing of summary statistics?
