...
From 2020, the GWAS Catalog started accepting submissions for pre-published and unpublished GWAS. Unpublished GWAS data is available through separate https://www.ebi.ac.uk/gwas/downloads[downloads], while summary statistics are available via our ftp://ftp.ebi.ac.uk/pub/databases/gwas/summary_statistics/[FTP site] and https://www.ebi.ac.uk/gwas/downloads/summary-statistics[summary statistics page]. SNP-trait associations are not available for pre-published and unpublished GWAS as these studies have not been curated yet.
...
Summary statistics files are available as soon as possible, even before the publication is included in our data release (approximately every three weeks).  Therefore, if a manuscript states that summary statistics are available from the Catalog and you cannot find them in the https://www.ebi.ac.uk/gwas/downloads/summary-statistics[list of studies with summary statistics files] or on our ftp://ftp.ebi.ac.uk/pub/databases/gwas/summary_statistics/[FTP site] please contact us at gwas-info@ebi.ac.uk and we can give you direct access to the files.
