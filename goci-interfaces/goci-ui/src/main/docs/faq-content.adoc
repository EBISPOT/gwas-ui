...
From 2020, the GWAS Catalog started accepting submissions for pre-published and unpublished GWAS. Unpublished GWAS data is available through separate studies and ancestry https://www.ebi.ac.uk/gwas/downloads[downloads]. SNP-trait associations are not available for pre-published and unpublished GWAS as these studies have not been curated.
