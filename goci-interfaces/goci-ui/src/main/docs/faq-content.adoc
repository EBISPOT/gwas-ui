...
* <<faqA9UnpublishedData, Does the GWAS Catalog include data that is not linked to a PubMed-indexed publication?>>
...
* <<faqB12AssociationUniqueness, Is each association in the GWAS Catalog unique?>>
...
* https://www.ebi.ac.uk/gwas/docs/ontology[Ontology] - details on ontology representation of GWAS traits
...
When citing the GWAS Catalog in a publication, use the most recent official GWAS Catalog publication and include the date you accessed the data.  The latest publication should be listed on our https://www.ebi.ac.uk/gwas/docs/about[About page].
