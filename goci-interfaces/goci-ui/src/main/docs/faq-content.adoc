...
* *Full genome-wide summary statistics:* Download from our ftp://ftp.ebi.ac.uk/pub/databases/gwas/summary_statistics/[FTP site] or from the https://www.ebi.ac.uk/gwas/downloads/summary-statistics[summary statistics page].
* *Programmatic access:* The REST API documentation is here: https://www.ebi.ac.uk/gwas/rest/docs/api.
* *Visualisation:* The GWAS Catalog diagram provides a graphical view of the data (see Section D).
...
* *Unpublished study submissions* (since 2020) — pre-prints, in-press, or standalone GWAS with full summary statistics and metadata (see <<faqA22, FAQ A22>>).
...
* *Mailing lists:*
** Announcements: email gwas-announce-join@ebi.ac.uk (subject: "subscribe")
** Contact the team: gwas-info@ebi.ac.uk
** User discussion: gwas-users@ebi.ac.uk (subscribe via email)
