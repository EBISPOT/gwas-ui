...
* *Web search interface:* https://www.ebi.ac.uk/gwas/search?query=[Search] by publication, study, trait, variant, or gene.
...
* https://www.ebi.ac.uk/gwas/docs/related-resources[Resources page] — other training materials, publications list, and external resources.
...
* *Mailing lists:*
** Announcements: email gwas-announce-join@ebi.ac.uk with subject: "subscribe". This is the best method to ensure you receive important announcements. 
...
* Bluesky: https://bsky.app/profile/gwascatalog.bsky.social[@gwascatalog.bsky.social]
* LinkedIn: https://bsky.app/profile/gwascatalog.bsky.social[GWAS Catalog]
...
*Diagram* The Diagram is updated quarterly. The data refresh date is shown in the Diagram page header. 

_Related search terms:_ update schedule, release frequency, data refresh, biweekly updates, summary statistics availability, missing files, diagram
...
* The https://www.ebi.ac.uk/gwas/docs/file-downloads#UnpublishedGWAS[prepublished download files].  

* The https://ftp.ebi.ac.uk/pub/databases/gwas/summary_statistics/[FTP site] and https://www.ebi.ac.uk/gwas/downloads/summary-statistics[summary statistics page].
...
* **Ensembl REST API:** Use the http://rest.ensembl.org/[Ensembl API] to map rsIDs to earlier assemblies. For GRCh37, use http://grch37.rest.ensembl.org/ and the http://grch37.rest.ensembl.org/documentation/info/variation_id[variation endpoint] to retrieve dbSNP mappings.  

_Related search terms:_ alternative genome builds, GRCh37, liftover, Ensembl REST API, assembly mapping, rsID conversion
