...
==== [[faq-B7]]4. Can I downlaod all associations for a particular gene or genomic region?

The GWAS Catalog website does not currently have a way to download all associations for a particular gene or genomic region. We are currently working to improve this functionality. For now, we recommend using our link:api-content[REST API] to return associations for a specific gene or genomic region.
