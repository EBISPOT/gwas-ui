...
==== [[faq-F2]]3. Can I find all associations for a particular ancestry?
...
==== [[faq-F3]]4. What does the "Pre-2011 ancestry not double-curated" flag next to some of the ancestry data mean?
...
==== [[faq-F4]]5. Why is the ancestry information provided in a separate downloadable spreadsheet to the rest of the study-level information?
