...
Instructions are provided below. When you have completed the submission form, return to the main submission instructions https://www.ebi.ac.uk/gwas/docs/submission#link-13[here^].
...
|md5 sum
|
|The md5 checksum of the summary statistics file. Leave blank for any studies without summary statistics. See <<checksums,how to calculate checksums>>. Alternative link <<summary-statistics-format.adoc#checksums,how to calculate checksums>>.
|
|no
|
