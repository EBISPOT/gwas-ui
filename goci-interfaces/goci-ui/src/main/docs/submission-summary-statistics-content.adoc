...
Most studies submitted to the GWAS Catalog are for SNP-based analyses. If you would also like to submit *gene-based or CNV-based summary statistics*, please contact gwas-subs@ebi.ac.uk for assistance.
