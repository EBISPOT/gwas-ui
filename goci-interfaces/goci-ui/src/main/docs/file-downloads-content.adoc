...
[width="80%",options="header",cols="4,4,2,2", halign = "center", role="table table-hover"]
|===
|Description | Download Link |Format  | Column header descriptions

|All associations *v1.0*
|link:../api/search/downloads/associations/v1.0?split=false[Download (full list)] +
 link:../api/search/downloads/associations/v1.0[Download (split by pub. year)]|tab separated file (zipped)
...
|link:../api/search/downloads/associations/v1.0.2?split=false[Download (full list)] +
 link:../api/search/downloads/associations/v1.0.2[Download (split by pub. year)]|tab separated file (zipped)
...
|All ancestry data *v1.0* _(link:faq#faqF1PopulationDescriptors[see FAQ F for more details])_
|link:../api/search/downloads/ancestry[ Click to download]
|tab separated file
|link:fileheaders#_file_headers_for_ancestry_download[ Click to view]

|All ancestry data *v1.0.3.1 - with added fields to match unpublished downloads (see below)* _(link:faq#faqF2SearchPopulationDescriptors[see FAQ F for more details])_
...
Older versions of the GWAS Catalog, with or without ontology annotations, can be found on link:https://ftp.ebi.ac.uk/pub/databases/gwas/releases[ our FTP server].
