...
2) at the GWAS Catalog ftp://ftp.ebi.ac.uk/pub/databases/gwas/summary_statistics/[FTP]. Where the harmonised files are available, they are nested within the harmonised directory in the study directory.
