...
Since April 2026, copy number variant (CNV) and gene-based GWAS data should follow the standards described in the https://www.ebi.ac.uk/gwas/apps/beyond-snps[beyond SNPs documentation]. Previously, these data were submitted to the Catalog without a standard schema, which limited downstream reuse.
