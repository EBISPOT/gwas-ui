...
The current version of the standard format is *GWAS-SSF* (published in https://doi.org/10.1101/2022.07.15.500230[Hayhurst et al., 2022^]).
...
* Summary statistics should be provided in one file per GWAS.
