...
|
|Genome assembly for the summary statistics. Must be entered for all studies with summary statistics. Enter "NR" for any studies without summary statistics.
|
|yes
|
|Must match one of the following options:
