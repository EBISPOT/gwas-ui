...
If your study includes replication samples that have not be analysed genome-wide, these should be added as additional rows, again separated by ancestry category.
