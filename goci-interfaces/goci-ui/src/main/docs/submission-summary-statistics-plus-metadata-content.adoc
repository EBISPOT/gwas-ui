...
[WARNING]
====
When filling in the metadata submission template, **do not change the structure of the file**.  
Do not rename or delete sheets, and do not alter hidden properties. Only enter your study details in the provided fields.  
Any structural edits may cause the submission to fail validation.
====
