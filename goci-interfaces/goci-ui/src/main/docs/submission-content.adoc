...
In order to create a submission, you will need to create an account and log in. User accounts are managed CILogon, which is shared across multiple life science services. You can find https://www.cilogon.org/faq[more information about CILogon here]. 
