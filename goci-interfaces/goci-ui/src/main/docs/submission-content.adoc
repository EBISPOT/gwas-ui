...
You may also like to watch our webinar, https://www.ebi.ac.uk/training/events/submitting-your-genome-wide-association-study-data-gwas-catalog/[_Submitting your genome wide association study data to the GWAS Catalog_], which walks through the main steps for submission.
