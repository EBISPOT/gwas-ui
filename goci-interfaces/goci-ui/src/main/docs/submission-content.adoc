...
1. <<Submitting, Submission homepage>>
...
1. <<LoginID, Create Elixir ID>>
2. <<InstallingGlobus, Install Globus Connect Personal>>
3. <<GlobusEmail, Enter registered Globus email>>
4. <<ValidateSumStats, Format and validate summary statistics>>
5. <<License, License agreement>>
6. <<CreateSubmission, Create submission>>

<<C, C. Uploading data>>

1. <<Upload, Upload summary statistics>>
2. <<SubmissionForm, Download submission form>>
3. <<Metadata, Fill in submission form>>
4. <<Submit, Submit submission form>>
5. <<DataRelease, After submission - release of data in the Catalog & how to find your accession IDs>>

<<D, Additional information>>

== [[A]]A. Preparing for submission

=== [[Submitting]]Submission homepage
...
=== [[InstallingGlobus]]2. Install Globus Connect Personal
...
=== [[GlobusEmail]]3. Enter registered Globus email
...
=== [[SubmissionForm]]2. Download submission form
...
=== [[Metadata]]3. Fill in submission form
...
=== [[DataRelease]]5. After submission - release of data in the Catalog & how to find your accession ID
