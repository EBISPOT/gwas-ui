...
The GWAS Catalog accepts summary statistics for both published and unpublished human genome-wide association studies.

We currently support submissions for GWAS analysing 3 main types of genetic variation:

* single-nucleotide polymorphisms (SNPs)
* gene-based (aggregated) analyses
* copy number variations (CNVs)

This page explains how to submit summary statistics for *SNP-based GWAS*.

To submit *gene-based or CNV GWAS* data please see the instructions at https://ebi.ac.uk/gwas/apps/beyond-snps/how-to-submit[GWAS Catalog: Beyond SNPs].

If you would like to submit *both* SNP-based and gene-based/CNV GWAS data, please contact us at gwas-subs@ebi.ac.uk for further guidance.

== How to submit summary statistics

To submit SNP-based summary statistics to the GWAS Catalog, please follow the steps below. 

You may also like to watch our webinar, https://www.ebi.ac.uk/training/events/data-submission-genome-wide-association-studies-gwas-catalog/[_Data submission for genome-wide association studies at the GWAS Catalog_], which walks through the main steps for submission. If you encounter technical difficulties at any point during submission and are unable to resolve these by reviewing the documentation, please reach out to our helpdesk via gwas-subs@ebi.ac.uk. 

EMBL-EBI's Data Preservation Statement can be found https://www.ebi.ac.uk/long-term-data-preservation[here].

Read on for general submission instructions. 

<<A, A. Preparing for submission>>

1. <<SubmissionHomepage, Submission homepage>>
2. <<FormatAndValidate, Format and validate summary statistics>>
3. <<Metadata, Publication/project metadata>>

<<B, B. Creating a submission>>

1. <<CreateAccount, Log in through CILogon>>
2. <<InstallGlobus, Install Globus Connect Personal>>
3. <<LinkGlobusAccount, Enter registered Globus email>>
4. <<ValidateSumstats, Format and validate summary statistics>>
5. <<LicenseTerms, License agreement>>
6. <<CreateSubmission, Create submission>>

<<C, C. Uploading data>>

1. <<Upload, Upload summary statistics>>
2. <<DownloadSubmissionForm, Download submission form>>
3. <<FillSubmissionForm, Fill in submission form>>
4. <<Submit, Submit submission form>>
5. <<ReleaseProcess, After submission - release of data in the Catalog & how to find your accession IDs>>

<<D, Additional information>>

== [[A]]A. Preparing for submission

=== [[SubmissionHomepage]]Submission homepage

Start by going to the https://www.ebi.ac.uk/gwas/deposition[GWAS Catalog Submission homepage^].

=== [[FormatAndValidate]]Format and validate summary statistics
...
*The flowchart below illustrates the steps for formatting and validating summary statistics before submission.*

image::Format_validate_sumstats.png[Formatting and validation steps,width=800,align="center"]

=== [[Metadata]]Submission questionnaire
...
*The flowchart below illustrates how to submit published and pre-published studies. The text below explains each step in more detail.*

image::Submission_questionnaire.png[Published and pre-published submission,width=800,align="center"]
...
=== [[CreateAccount]]1. Log in through CILogon

In order to create a submission, you will need to create an account and log in. User accounts are managed by CILogon, which is shared across multiple life science services. You can find https://www.cilogon.org/faq[more information about CILogon here]. 

Follow the https://www.ebi.ac.uk/gwas/deposition/login[CILogon link^] and select an identity provider you have an existing account with - including Google, LinkedIn, ORCID and most academic institutions. Once linked, you should be directed back to our Submission App where you can create and view ongoing or past submissions.  

=== [[InstallGlobus]]2. Install Globus Connect Personal
...
=== [[LinkGlobusAccount]]3. Enter registered Globus email
...
=== [[ValidateSumstats]]4. Format and validate summary statistics
...
=== [[LicenseTerms]]5. License agreement
...
=== [[CreateSubmission]]6. Create submission
...
*The flowchart below illustrates the steps for uploading your data during the submission process. The text below explains each step in more detail.*

image::Uploading_submission.png[Uploading process,width=1000,align="center"]

=== [[Upload]]1. Upload summary statistics
...
In the Globus File Manager, the GWAS Catalog submission folder will appear in the left-hand panel. It will have a Collection name beginning with the date, followed by some additional characters.

image::file_manager.png[Globus File Manager,width=800,align="center"]

{empty}

In the right-hand panel, click on the Search box and then select your Globus Connect Personal endpoint from the *Your Collections* tab.  This should have the name that you entered when installing Globus Connect Personal in <LinkGlobusAccount, step B2>>.
...
=== [[DownloadSubmissionForm]]2. Download submission form
...
=== [[FillSubmissionForm]]3. Fill in submission form
...
=== [[Submit]]4. Submit submission form
...
=== [[ReleaseProcess]]5. After submission - release of data in the Catalog & how to find your accession ID
...
Our data release runs bi-weekly, so it may take a few days for your studies to appear on the GWAS Catalog website. Non-embargoed studies will be added to the summary statistics download area here: https://www.ebi.ac.uk/gwas/downloads/summary-statistics[Summary Statistics Downloads]. You can search for a study’s accession number on our homepage to find its landing page and metadata: https://www.ebi.ac.uk/gwas[GWAS Homepage]. Additional metadata will be available in the downloadable files here: https://www.ebi.ac.uk/gwas/docs/file-downloads[File Downloads]. If more than 2 weeks has passed and you have concerns, please contact us. 
...
*The flowchart below illustrates what happens after submission, including data release timelines and how your study becomes publicly available in the GWAS Catalog.*

image::After_submission.png[After submission process,width=800,align="center"]
