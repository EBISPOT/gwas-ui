...
|
|https://www.ebi.ac.uk/gwas/docs/summary-statistics[Summary statistics only]
...
|
|https://www.ebi.ac.uk/gwas/docs/summary-statistics-plus-metadata[Summary statistics plus study metadata]
