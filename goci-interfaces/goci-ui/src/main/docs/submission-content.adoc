...
*The flowchart below illustrates how to submit published and pre-published studies.*

image::Creating_submission.png[Published and pre-published submission,width=800,align="center"]
...
*The flowchart below illustrates the steps for uploading your data during the submission process.*
