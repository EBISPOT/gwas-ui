...
A 2021 https://www.ebi.ac.uk/training/events/submitting-your-genome-wide-association-study-data-gwas-catalog/[webinar] providing a step-by-step guide to the summary statistics submission process to the GWAS Catalog.

A 2021 http://blog.opentargets.org/2021/03/11/open-sharing-of-cancer-summary-statistics/[blog post] calling for more freely available cancer GWAS summary statistics.
