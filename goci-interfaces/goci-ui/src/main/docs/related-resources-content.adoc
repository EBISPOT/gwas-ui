...
Please note that all the GWAS Catalog training resources below refer to our old website, and have not yet been updated to include the new functionality. They should be used for background information only.
...
Buniello et al, 2019. link:https://academic.oup.com/nar/article/47/D1/D1005/5184712[The NHGRI-EBI GWAS Catalog of published genome-wide association studies, targeted arrays and summary statistics 2019]. Nucleic Acids Research, 2019, Vol. 47 (Database issue): D1005-D1012.
