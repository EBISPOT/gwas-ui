...
In order to support the growing number of summary statistics, on 5th Feb 2021 we changed the structure of the summary statistics FTP directory.


==== What is not changing?

The path to summary statistics parent directory remains the same 'ftp.ebi.ac.uk/pub/databases/gwas/summary_statistics/'.
All existing child paths remain the same - but these will be retired on 1st Sept 2021.
...
Please note: The old-style directories will be removed on 1st Sept 2021 i.e. any summary statistics directories under ftp.ebi.ac.uk/pub/databases/gwas/summary_statistics/ that is NOT in a range of a thousand bin (e.g. GCST000001-GCST001000) will be removed.

Many thanks and please contact us at gwas-info@ebi.ac.uk if you have any concerns.
