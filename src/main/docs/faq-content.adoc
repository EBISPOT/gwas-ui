...
From 2020, the GWAS Catalog started accepting submissions for pre-published and unpublished GWAS. Unpublished GWAS metadata is available through separate https://www.ebi.ac.uk/gwas/downloads[downloads], while summary statistics are available via our ftp://ftp.ebi.ac.uk/pub/databases/gwas/summary_statistics/[FTP site] and https://www.ebi.ac.uk/gwas/downloads/summary-statistics[summary statistics page]. SNP-trait associations are not available for pre-published and unpublished GWAS as these studies have not been curated yet.
